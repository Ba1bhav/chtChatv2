import { Component, OnInit, ChangeDetectorRef, AfterContentInit, AfterContentChecked } from '@angular/core';
...
export class SearchUserComponent implements OnInit, AfterContentInit, AfterContentChecked {
  urls = urls
  dataBase: any;
  ...
  constructor(private router: Router,
    ...
    this.dataService.getProfileUpdate().subscribe(()=>{
